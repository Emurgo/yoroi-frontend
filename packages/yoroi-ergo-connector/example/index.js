        ...
        if (!access_granted) {
            ...
            ergo.get_balance().then(async function(result) {
                ...
                button.onclick = async function() {
                    ...
                    const token = new wasm.Token(wasm.TokenId.from_box_id(wasm.BoxId.from_str(utxos[1].boxId)), wasm.TokenAmount.from_i64(wasm.I64.from_str("100000")));
                    const donationBoxBuilder = new wasm.ErgoBoxCandidateBuilder(
                        ...
                        creationHeight);
                    donationBoxBuilder.mint_token(token, "ECEDT", "Ergo Connector Example Dapp Token (for testing)", 2);
