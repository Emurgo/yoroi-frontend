...
import {chromeExtIdUrl, firefoxBin, firefoxExtIdUrl, firefoxUuidMapping, TargetBrowser} from './helpers/constants.js'
...
const getFirefoxBuilder = () => {
  ...
  const options = new firefox.Options()
    ...
    .setPreference('browser.helperApps.neverAsk.saveToDisk', 'application/csv, text/csv, application/pdfss, text/csv, application/excel')
