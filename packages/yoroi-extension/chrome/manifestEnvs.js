...
const POOLS_UI_URL_FOR_YOROI: string =
  process.env.POOLS_UI_URL_FOR_YOROI != null
 ...
 */
const SEIZA_URL: string =
  process.env.SEIZA_URL != null
    ? process.env.SEIZA_URL // suggested: 'http://localhost:3000'
    : 'https://adapools.yoroiwallet.com';

const CHANGELLY_URL: string = process.env.changelly_url != null ? process.env.changelly_url : 'https://widget.changelly.com/';
