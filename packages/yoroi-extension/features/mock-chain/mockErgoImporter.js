  ...
  result.push((() => {
    ...
    return {
      ...
      outputs: [replaceMockOutputBoxId({
        ...
        ergoTree: Buffer.from(RustModule.SigmaRust.Address.from_base58(address).to_ergo_tree().sigma_serialize_bytes()).toString('hex'),
        id: '',
        txId: hash,
        index: 0,
        mainChain: true,
    ...
    return {
      ...
      outputs: [
        ...
        replaceMockOutputBoxId({
          ...
          assets: [],
          creationHeight: height,
          ergoTree: Buffer.from(simpleAddress.address().to_ergo_tree().sigma_serialize_bytes()).toString('hex'),
          id: '',
          txId: hash,
          index: 0,
          mainChain: true,
        ...
        replaceMockOutputBoxId({
          ...
          assets: [],
          creationHeight: height,
          ergoTree: Buffer.from(tokenAddress.address().to_ergo_tree().sigma_serialize_bytes()).toString('hex'),
          id: '',
          txId: hash,
          index: 1,
          mainChain: true,
