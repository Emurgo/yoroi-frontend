...
export const dark = {
  ...
  el_gray_medium: darkPalette.gray_c900, // icons, shapes, lines in buttons, chips, tabs, checkboxes, readio, switch
  el_gray_low: darkPalette.gray_c600, // icons, shapes, inputs, bottom navigation bar
