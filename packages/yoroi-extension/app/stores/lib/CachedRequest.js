...
export default class CachedRequest<Func: (...args: any) => Promise<any>, Error> extends Request<Func, Error> {
   ...
   */
  invalidate(options: {| immediately: boolean |} = { immediately: false }): CachedRequest<Func, Error> {
    this._isInvalidated = true;
