...
const mockData = {
  common: {
    walletBalance: {
      ada: Number((100000 * Math.random()).toFixed(2)),
      usd: Number((1000 * Math.random()).toFixed(2)),
      percents: Number(Math.random().toFixed(2)),
    ...
    tokenList: [
      {
        name: 'AGIX',
        id: 'Agix',
        price: Number((10 * Math.random()).toFixed(2)),
        portfolioPercents: Math.round(100 * Math.random()),
        '24h': -Number((10 * Math.random()).toFixed(2)),
        '1W': Number((10 * Math.random()).toFixed(2)),
        '1M': Number((10 * Math.random()).toFixed(2)),
        totalAmount: Number((100000 * Math.random()).toFixed(3)),
        totalAmountUsd: Number((100000 * Math.random()).toFixed(3)),
        overview: {
          description:
        ...
        performance: [
          ...
          { value: (1000 * Math.random()).toFixed(2) },
          { value: null },
          { value: Number((10 * Math.random()).toFixed(2)) },
      ...
      },
      {
        ...
        '1W': Number((10 * Math.random()).toFixed(2)),
        '1M': -Number((10 * Math.random()).toFixed(2)),
        totalAmount: Number(Math.round(100000 * Math.random()).toFixed(2)),
        totalAmountUsd: Number(Math.round(100000 * Math.random()).toFixed(2)),
        overview: {
          description:
            "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, ",
          website: 'https://www.cardano.org',
    ...
    liquidityList: [
      {
        ...
        lpTokens: Number((Math.random() * 1000000).toFixed(2)),
        totalValue: Number((Math.random() * 1000).toFixed(2)),
        totalValueUsd: Number((Math.random() * 100).toFixed(2)),
        firstTokenValue: Number((Math.random() * 100).toFixed(2)),
        firstTokenValueUsd: Number((Math.random() * 100).toFixed(2)),
        secondTokenValue: Number((Math.random() * 10000).toFixed(2)),
        secondTokenValueUsd: Number((Math.random() * 10).toFixed(2)),
      },
      {
        id: Math.random(),
    ...
    orderList: [
      {
        ...
        totalValue: Number((Math.random() * 10).toFixed(2)),
        totalValueUsd: Number((Math.random() * 10).toFixed(2)),
      },
      {
        id: Math.random(),
        pair: 'MILK/LVLC',
  ...
  transactionHistory: [
    {
      ...
      feeValue: Number(Math.random().toFixed(2)),
      feeValueUsd: Number(Math.random().toFixed(2)),
      amountTotal: Number((1000000 * Math.random()).toFixed(5)),
      amountTotalUsd: Number((100000 * Math.random()).toFixed(2)),
