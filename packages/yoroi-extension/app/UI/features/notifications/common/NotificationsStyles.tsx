...
.Toastify__toast--fade-in-top {
  animation: slideInFromTop 200ms ease-in-out forwards;
}
.Toastify__toast--fade-out-top {
  animation: slideOutUp 200ms ease-in-out forwards !important;
}
`} />
  )
}