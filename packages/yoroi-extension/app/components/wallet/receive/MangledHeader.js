    ...
    return (
      <>
        <WarningHeader
          message={
            <>
              <div>{intl.formatMessage(messages.warning1, { ticker: this.props.ticker })}</div>
              <br />
              <div>
        ...
        >
          {this.props.hasMangledUtxo && (
            <Button variant="primary" onClick={this.props.onClick} sx={{ width: 'max-content', marginTop: '16px' }}>
