...
const errors = defineMessages({
  incorrectDevice: {
    ...
    defaultMessage:
      '!!!Incorrect device detected. Expected device {expectedDeviceId}, but got device {responseDeviceId}. Please plug in the correct device',
  },
  incorrectVersion: {
...
export class IncorrectDeviceError extends LocalizableError {
  constructor(values: {| expectedDeviceId: string, responseDeviceId: string |}) {
    super({
...
export class IncorrectVersionError extends LocalizableError {
  constructor(values: {| supportedVersions: string, responseVersion: string |}) {
    super({
