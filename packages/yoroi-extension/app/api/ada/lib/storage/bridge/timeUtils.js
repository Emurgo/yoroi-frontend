...
export default class TimeUtils {
  static toAbsoluteSlotNumber(config: $ReadOnlyArray<CardanoHaskellConfig>, relativeSlot: RelativeSlot): number {
  ...
  static toRelativeSlotNumber(config: $ReadOnlyArray<CardanoHaskellConfig>, absoluteSlot: number): RelativeSlot {
  ...
  static timeToAbsoluteSlot(config: $ReadOnlyArray<CardanoHaskellConfig>, time: Date): number {
  ...
  static secondsSinceGenesis(config: $ReadOnlyArray<CardanoHaskellConfig>, absoluteSlotNum: number): number {
  ...
  static absoluteSlotToTime(config: $ReadOnlyArray<CardanoHaskellConfig>, absoluteSlotNum: number): Date {
  ...
  static currentEpochSlots(config: $ReadOnlyArray<CardanoHaskellConfig>): number {
    return (
      cardanoHaskellConfigCombine(config).SlotsPerEpoch ?? fail(`${nameof(TimeUtils.currentEpochSlots)} missing slots per epoch`)
    );
  }

  static currentSlotSeconds(config: $ReadOnlyArray<CardanoHaskellConfig>): number {
    return (
      cardanoHaskellConfigCombine(config).SlotDuration ?? fail(`${nameof(TimeUtils.currentSlotSeconds)} missing slot duration`)
    );
  }
}
