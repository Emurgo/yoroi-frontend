...
const CardanoPreprodTestnetExplorers: Array<$ReadOnly<ExplorerRow>> = [
  {
    ...
    IsBackup: true,
    Endpoints: {
      address: 'https://preprod.cardanoscan.io/address/',
      transaction: 'https://preprod.cardanoscan.io/transaction/',
      pool: 'https://preprod.cardanoscan.io/pool/',
      stakeAddress: 'https://preprod.cardanoscan.io/stakeKey/',
      token: 'https://preprod.cardanoscan.io/token/',
    },
    Name: 'CardanoScan',
  },
];
...
export const prepackagedDefaultExplorers: Map<number, $ReadOnly<ExplorerRow>> = new Map([
  ...
  [networks.CardanoPreviewTestnet.NetworkId, getOrThrow(CardanoPreviewTestnetExplorers.find(explorer => explorer.IsBackup))],
]);
