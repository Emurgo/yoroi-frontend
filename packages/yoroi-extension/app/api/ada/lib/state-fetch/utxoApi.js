// @flow
import { BatchedEmurgoUtxoApi, EmurgoUtxoApi } from '@emurgo/yoroi-lib/dist/utxo/emurgo-api';
...
export default class UtxoApi extends BatchedEmurgoUtxoApi {
  ...
  static utxoApiFactory: string => UtxoApiContract = backendServiceUrl => new EmurgoUtxoApi(backendServiceUrl + '/api/', true);
