...
export async function getAllTokenInfo(request: GetTokenInfoRequest): Promise<GetTokenInfoResponse> {
  ...
  return await raii<GetTokenInfoResponse>(request.db, depTables, async tx => deps.GetToken.all(request.db, tx));
}
