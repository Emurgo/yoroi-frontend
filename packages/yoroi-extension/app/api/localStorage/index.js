...
export default class LocalStorageApi {
  ...
  getMidnightBannerPhase2Closed: void => Promise<?string> = () => getLocalItem(storageKeys.MIDNIGHT_BANNER_ANNOUNCEMENT_CLOSED);
  ...
  unsetMidnightBannerPhase2Closed: void => Promise<void> = () => removeLocalItem(storageKeys.MIDNIGHT_BANNER_ANNOUNCEMENT_CLOSED);
