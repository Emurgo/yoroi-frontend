...
export class GovernanceChooseDrepPageViewed implements BaseEvent {
  ...
  constructor(
    public event_properties?: GovernanceChooseDrepPageViewedProperties,
  ) {
    this.event_properties = event_properties;
  }
}
...
export class GovernanceYoroiDRepSubmitted implements BaseEvent {
  event_type = 'Governance Yoroi DRep Submitted';

  constructor(
    public event_properties?: GovernanceYoroiDRepSubmittedProperties,
  ) {
    this.event_properties = event_properties;
  }
}
...
export class MidnightAirdropBannerCheckEligibility implements BaseEvent {
  event_type = 'Midnight Airdrop Banner Check Eligibility';
}

export class MidnightAirdropBannerClosed implements BaseEvent {
  event_type = 'Midnight Airdrop Banner Closed';
}

export class MidnightAirdropLeftMenuClicked implements BaseEvent {
  event_type = 'Midnight Airdrop Left Menu Clicked';
}

export class MidnightAirdropPageViewed implements BaseEvent {
  event_type = 'Midnight Airdrop Page Viewed';

  constructor(
    public event_properties?: MidnightAirdropPageViewedProperties,
  ) {
    this.event_properties = event_properties;
  }
}

export class MidnightAirdropSignMessage implements BaseEvent {
  event_type = 'Midnight Airdrop Sign Message';
}
...
export class Ampli {
  ...
  */
  ...
  governanceChooseDrepPageViewed(
    properties?: GovernanceChooseDrepPageViewedProperties,
    options?: EventOptions,
  ) {
   ...
   * @param options Amplitude event options.
   */
  governanceYoroiDRepSubmitted(
    properties?: GovernanceYoroiDRepSubmittedProperties,
    options?: EventOptions,
  ) {
   ...
   * @param options Amplitude event options.
   */
  midnightAirdropBannerCheckEligibility(
    options?: EventOptions,
  ) {
   ...
   * @param options Amplitude event options.
   */
  midnightAirdropLeftMenuClicked(
    options?: EventOptions,
  ) {
   ...
   * @param options Amplitude event options.
   */
  midnightAirdropPageViewed(
    properties?: MidnightAirdropPageViewedProperties,
    options?: EventOptions,
  ) {
