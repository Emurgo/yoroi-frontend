...
const suggestions = WordLists.map(word => ({
  value: word,
  label: word,
}));
...
class Bip39Autocomplete extends React.Component {
  render() {
...
export default withStyles(styles)(Bip39Autocomplete);
