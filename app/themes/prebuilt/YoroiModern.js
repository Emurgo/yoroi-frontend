...
if (environment.isShelley()) {
  ShelleyTestnetOverrides = {
    ...
    // Button Primary
    '--theme-button-primary-background-color': '#17D1AA',
    '--theme-button-primary-background-color-hover': '#1DE6BC',
    '--theme-button-primary-background-color-active': '#17D1AA',
    '--theme-button-primary-background-color-disabled': '#C9EDE5',
    // Button Outline
    '--theme-button-outlined-text-color': '#15D1AA',
    '--theme-button-outlined-border-color': '#17D1AA',
    '--theme-button-outlined-border-color-hover': '#1DE6BC',
    '--theme-button-outlined-background-color': '#FFFFFF',
    '--theme-button-outlined-background-color-hover': '#F2FDFB',
    '--theme-button-outlined-background-color-active': '#17D1AA',
    '--theme-button-outlined-active-text-color': '#ffffff',
